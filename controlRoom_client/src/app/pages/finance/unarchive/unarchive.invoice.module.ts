...
import { UnarchiveInvoiceComponent } from './unarchive.invoice.component';
...
@NgModule({
    ...
    declarations: [UnarchiveInvoiceComponent],
    exports: [UnarchiveInvoiceComponent],
	schemas: [CUSTOM_ELEMENTS_SCHEMA]
})

export class UnarchiveInvoiceModule { }
