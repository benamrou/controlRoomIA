...
import { ItemAttributeDatedComponent } from './item.attribute.dated.component';
...
@NgModule({
    ...
    declarations: [ItemAttributeDatedComponent],
    exports: [ItemAttributeDatedComponent],
	schemas: [CUSTOM_ELEMENTS_SCHEMA]
})

export class ItemAttributeDatedModule { }
