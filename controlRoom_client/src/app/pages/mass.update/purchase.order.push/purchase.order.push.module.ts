...
import { PurchaseOrderPushComponent } from './purchase.order.push.component';
...
@NgModule({
    ...
    declarations: [PurchaseOrderPushComponent],
    exports: [PurchaseOrderPushComponent],
	schemas: [CUSTOM_ELEMENTS_SCHEMA]
})

export class PurchaseOrderPushModule { }
