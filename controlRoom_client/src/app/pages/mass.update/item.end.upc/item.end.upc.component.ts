...
export class ItemEndUPCComponent implements OnInit{
  ...
  ngOnInit() {
      this.menuItems = [{
              ...
              title: 'Pick your item end barcode file',
              command: (event: any) => {
                  this.activeIndex = 0;
                  this._messageService.add({key:'top', sticky:true, severity:'info', summary:'Pick your data file item end barcode', detail: event.item.label});
              }
          },
          {
              id: 'step1',
