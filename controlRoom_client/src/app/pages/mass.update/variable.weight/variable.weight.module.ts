...
import { VariableWeightComponent } from './variable.weight.component';
...
@NgModule({
    ...
    declarations: [VariableWeightComponent],
    exports: [VariableWeightComponent],
	schemas: [CUSTOM_ELEMENTS_SCHEMA]
})

export class VariableWeightModule { }
