...
import { ItemListDescriptionComponent } from './itemlist.description.component';
...
@NgModule({
    ...
    declarations: [ItemListDescriptionComponent],
    exports: [ItemListDescriptionComponent],
	schemas: [CUSTOM_ELEMENTS_SCHEMA]
})

export class ItemListDescriptionModule { }
