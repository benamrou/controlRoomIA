...
export class HttpService  {
  ...
  constructor(private httpClient: HttpClient, private _router: Router, private _userDataService: UserDataService) {
  ...
  getMock(url: string, paramOtions?: HttpParams, headersOption?:HttpHeaders, responseType?): Observable<Response> {
    let token = this._userDataService.ICRAuthToken;
    let user = this._userDataService.ICRUser;
    ...
    headersOption.set('USER', this._userDataService.ICRUser);
  ...
  get(url: string, paramOptions?: HttpParams, headersOption?:HttpHeaders, externalUrl?: boolean): Observable<Response> {
    ...
    if (!externalUrl) {
      ...
      headersOption = headersOption.set('USER', this._userDataService.ICRUser);
      headersOption = headersOption.set('Authorization', this._userDataService.ICRAuthToken);
      headersOption = headersOption.set('DATABASE_SID', this._userDataService.ICRSID);
      headersOption = headersOption.set('LANGUAGE', this._userDataService.ICRLanguage);
    }
  ...
  post(url: string,  paramOptions?: HttpParams, headersOption?:HttpHeaders, bodyOptions?: any,externalUrl?: boolean): Observable<Response> {
    ...
    let token = this._userDataService.ICRAuthToken;
    let user = this._userDataService.ICRSID;
    let myTransaction = this.addTransaction();
    let body = {}
    ...
    if (!externalUrl) {
      ...
      headersOption = headersOption.set('USER', this._userDataService.ICRSID);
      headersOption = headersOption.set('Authorization', this._userDataService.ICRAuthToken);
      headersOption = headersOption.set('DATABASE_SID', this._userDataService.ICRSID);
      headersOption = headersOption.set('LANGUAGE', this._userDataService.ICRLanguage);
    }
  ...
  execute(url: string, paramOptions?: HttpParams, headersOption?:HttpHeaders, bodyOptions?): Observable<Response> {
    ...
    headersOption = headersOption.set('DATABASE_SID', this._userDataService.ICRSID);
    headersOption = headersOption.set('LANGUAGE', this._userDataService.ICRLanguage);
    headersOption = headersOption.set('ENV_IP', this._userDataService.ENV_IP);
    headersOption = headersOption.set('ENV_ID', this._userDataService.ENV_ID);
    headersOption = headersOption.set('ENV_PASS', this._userDataService.ENV_PASS);
