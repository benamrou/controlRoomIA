...
export class LogginService{
    ...
    private baseAuthentificationUrl: string = '/api/authentification/oneway/';
    private baseEnvironmentUrl: string = '/api/user/';
    public token: string;


    constructor(private _http: HttpService, private _userDataService: UserDataService) {
    ...
    login(username: string, password: string): Observable<boolean> {
        ...
        return this._http.authentification(request, options).pipe(map(response => {
                ...
                if (token) {
                    ...
                    this._userDataService.ICRAuthToken = token;
                    this._userDataService.ICRUser = data.USERID;
    ...
    logout(): void {
        ...
        //console.log('***** Logout ****');
        this.token = '';
        this._userDataService.ICRAuthToken = '';
        this._userDataService.ICRUser = '';
        this._userDataService.ICRSID = '';
        this._userDataService.ICRLanguage = '';
